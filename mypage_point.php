        ...
        <div id="mypage">
            ...
            <div id="mypage_content">
                ...
                <form name="qnafrm">
                    ...
                    $row=mysqli_fetch_array($rs);
                    $m_no=$row["m_no"];
                    $pointsql="select * from point where m_no=$m_no order by no desc";
                    ...
                    <table class="mypage_notice">
                        ...
                        <?php while($row2=mysqli_fetch_array($pointrs)){?>
                        <tr>
                            <td><?php echo $row2["date"]?></td>
                            <td><?php echo $row2["content"]?></td>
                            <td><?php echo $row2["usePoint"]?></td>
                        </tr>
                        <?php } ?>
                        <?php 
                        $totalsql="select * from point where m_no=$m_no order by no desc limit 0,1";
                        $totalrs=mysqli_query($conn,$totalsql);
                        $totalrow=mysqli_fetch_array($totalrs);
                        ?>
                        <tr>
                            <td colspan="3">
                                잔여 적립금 : <?php echo $totalrow["point"]?> 점
                            </td>
                        </tr>
                    </table>
                </form>
