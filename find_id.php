    ...
    <div id="wrap">
        <div id="login_wrap">
            <form name="frm1" method="post" action="id_ok.php">
                <ul class="login_list">
                    <li>
                        <div class="login_title">이름</div>
                        <input type="text" name="name" class="login_text"placeholder="이름을 입력하세요.">
                    </li>
                    <li>
                        <b> </b>
                    </li>
                    ...
                    <li>
                        <input type="button" value="아이디 찾기" class="login_bt1" onclick="send()">
                    </li>
                    <li>
