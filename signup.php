...
<body>
 <!-- 헤더 시작 -->
    ...
    <div id="wrap">
        <div id="login_wrap">
            <form name="signfrm" method="post" action="signup_ok.php">
                <ul class="signup_list">
                    <li style="text-align: center;"><h1>Signup</h1>
                        <p>회원가입 시 즉시 사용 가능한 3,000원 혜택을 드립니다.</p></li>
                    <li>
                        <p>아이디</p>
                        <input type="text" placeholder="계정혹은 아이디를 입력하세요." name="id" class="signup_text">
                        <input type="hidden" placeholder="계정혹은 아이디를 입력하세요." name="id2" class="signup_text">
                        
                    </li>
                    <li>
                        <div onclick="id_check()" class="idcheck_bt">아이디 중복확인</div>
                        <script>
                            function id_check(){
                                if(signfrm.id.value==""){
                                    alert("계정 혹은 ID를 입력하세요");
                                    signfrm.id.focus();return false;
                                }else{
                                    window.open("id_check.php?id="+signfrm.id.value,"_blank","width=500px,height=400px");
                                }
                            }
                        </script>
                    </li>
                    ...
                    <li>
                        <p>이름</p>
                        <input type="text" placeholder="이름을 입력하세요." name="name" class="signup_text">
                    </li>
                    <li>
                        <p>연락처</p>
                        <input type="text" placeholder="연락처를 입력하세요." name="tel" class="signup_text">
                    </li>
                    <li>
                        <p>생년월일</p>
                        <input type="text" placeholder="생년월일을 입력하세요." name="birthday" class="signup_text">
                    </li>
                   <li><input type="button" value="회원가입" class="signup_bt" onclick="signup()"></li>
                </ul>
                <script>
                    function signup(){
                        if(signfrm.id.value==""){
                        ...
                        if(signfrm.id2.value==""){
                            alert("아이디 중복체크를 해주세요.");
                            signfrm.id2.focus();return false;
                        }
                        if(signfrm.pw.value==""){
                            alert("비밀번호를 입력하세요.");
