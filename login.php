            ...
            <form name="frm1" method="post" action="login_ok.php">
                <ul class="login_list">
                    <li>
                        ...
                        <input type="text" name="id" class="login_text"placeholder="ID를 입력하세요.">
                    </li>
                    <li>
                        <b><a href="find_id.php">계정을 잊으셨나요?</a></b>
                    </li>
                    <li>
                        <div class="login_title">Password</div>
                        <input type="password" name="pw" class="login_text"placeholder="비밀번호를 입력하세요.">
                    </li>
                    <li>
                        <b onclick="location.href='find_pw.php'">비밀번호를 잊으셨나요?</b>
                    </li>
                    <li>
                        <input type="button" value="Login" class="login_bt1" onclick="send()">
                    </li>
                    <li>
                        <input type="button" value="Signup" class="login_bt2" onclick="location.href='signup.php'">
                    </li>
                    <li>
                        <input type="button" value="비회원 주문 조회" class="login_bt2" style="background-color:white" onclick="popup()">
                        <script>
                            function popup(){
                                window.open('nonmypage.php','_blank','width=500px,height=400px')
                            }
                        </script>
                    </li>
                </ul>
